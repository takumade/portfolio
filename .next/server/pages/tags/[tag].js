...
/* harmony import */ var _lib_generate_rss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9926);
/* harmony import */ var _lib_mdx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4503);
/* harmony import */ var _lib_tags__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5957);
...
const getStaticProps = async (context)=>{
    ...
    if (filteredPosts.length > 0) {
        const rss = (0,_lib_generate_rss__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)(filteredPosts, `tags/${tag}/feed.xml`);
        const rssPath = path__WEBPACK_IMPORTED_MODULE_9___default().join(root, "public", "tags", tag);
...
var __webpack_exports__ = __webpack_require__.X(0, [686,505,397,664,966,576,503,829,173,834,926], () => (__webpack_exec__(8298)));
