...
/* harmony import */ var _lib_generate_rss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9926);
/* harmony import */ var _components_MDXComponents__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7253);
...
async function getStaticPaths() {
    const posts = (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_5__/* .getFiles */ .bE)("snippets");
    return {
        paths: posts.map((p)=>({
                params: {
...
const getStaticProps = async ({ params  })=>{
    ...
    const allPosts = await (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_5__/* .getAllFilesFrontMatter */ .sj)("snippets");
    ...
    const post1 = await (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_5__/* .getFileBySlug */ .x7)("snippets", slug);
    // @ts-ignore
...
var __webpack_exports__ = __webpack_require__.X(0, [686,505,397,664,675,152,966,576,503,829,173,834,361,403,769,926,253], () => (__webpack_exec__(6045)));
